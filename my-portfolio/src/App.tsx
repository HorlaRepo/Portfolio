...
import {
  ...
  Linkedin, Download, ExternalLink
} from 'lucide-react';
            ...
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
                    <motion.div className="lg:col-span-3 space-y-6 text-lg text-neutral-300 leading-relaxed" initial={{ opacity: 0, x: -50 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }}>
                        <p>As a Senior Software Engineer with over 8 years of experience, I build high-trust digital products across B2B SaaS, marketplaces, fintech, and AI commerce. My work spans scalable backend systems, polished customer-facing experiences, and the operational tooling needed to run products reliably in production.</p>
                        <p>Recent work includes Ordira, a commerce AI SaaS for WhatsApp ordering, NexHrm, a multi-tenant HR SaaS platform, and client products in education, cross-border payments, and investments. I focus on shipping systems that balance speed, product polish, and long-term maintainability.</p>
...
const Projects: React.FC = () => {
    ...
    const projects: Project[] = [
        ...
        { title: 'NexHrm - B2B HR SaaS Platform', description: 'Multi-tenant HR SaaS for payroll, recruitment, performance, and workforce operations.', detailDescription: 'Architected a comprehensive B2B HR SaaS platform with a multi-tenant architecture and robust administrative workflows. The product supports employee information management, payroll, performance management, recruitment, onboarding, and time tracking for multiple organizations. Built for scale, operational clarity, and role-based access across a growing set of business-critical modules.', technologies: ['Java', 'Spring Boot', 'React', 'PostgreSQL', 'AWS', 'Multi-Tenancy'], featured: true, liveUrl: 'https://app.nexhrm.com' },
        { title: 'GrapevinePay - Cross-Border Payment Platform', description: 'Cross-border payment solution for multicurrency business and freelancer transactions.', detailDescription: 'Built product flows for cross-border and multicurrency payments aimed at businesses and freelancers whose use cases are poorly served by standard bank and remittance products. The platform centers on payment clarity, transfer reliability, and a straightforward customer experience around sending, receiving, and tracking international funds. This project strengthened my experience with payment-heavy systems where correctness, trust, and operational visibility are non-negotiable.', technologies: ['Next.js', 'TypeScript', 'Payments', 'Webhooks', 'PostgreSQL', 'Tailwind CSS'], featured: true, liveUrl: 'https://grapevinepay.com/' },
        { title: 'Ordira - Commerce AI SaaS for WhatsApp Ordering', description: 'AI-powered commerce assistant that turns WhatsApp conversations into paid food orders.', detailDescription: 'Ordira eliminates the manual overhead of food vendors managing orders on WhatsApp. Vendors register their menu, pricing, and policies once, then an AI assistant powered by Claude handles customer conversations: answering questions, building carts, validating orders against live catalog data, generating payment links, and notifying vendors on confirmed payment. The backend remains the source of truth for pricing, availability, and payment status.', technologies: ['NestJS', 'TypeScript', 'Claude AI', 'PostgreSQL', 'BullMQ', 'Paystack', 'WhatsApp Cloud API', 'GCP'], featured: true, liveUrl: 'https://www.tryordira.com', status: 'In Development' },
        { title: 'Zitra Investments - Digital Investment Platform', description: 'Investment and financial services platform spanning wealth products, client accounts, and lending touchpoints.', detailDescription: 'Delivered product engineering for a digital investment platform serving users across investment and financial-service journeys. The platform emphasizes trust, clean information design, and secure account experiences around financial products, portfolio visibility, and supporting operational workflows. It is the kind of fintech build where usability and credibility are as important as the underlying transaction logic.', technologies: ['Next.js', 'TypeScript', 'Fintech UX', 'Secure Auth', 'PostgreSQL', 'Dashboards'], featured: true, liveUrl: 'https://zitrainvestments.com/' },
        { title: 'WaveSend - AI-Powered Money Transfer', description: 'Next-gen transfer platform with intelligent conversational AI.', detailDescription: 'Revolutionizing money transfers with an intelligent AI bot that understands natural language. Users can seamlessly transfer funds, schedule payments, check balances, and more through intuitive conversations. The AI assistant detects user intent, processes complex requests, and delivers instant responses, making financial transactions feel conversational without sacrificing speed or accuracy.', technologies: ['React', 'TypeScript', 'Node.js', 'AI/NLP', 'PostgreSQL', 'Python', 'Firebase'], featured: false, liveUrl: 'https://wavesend-app.netlify.app' },
